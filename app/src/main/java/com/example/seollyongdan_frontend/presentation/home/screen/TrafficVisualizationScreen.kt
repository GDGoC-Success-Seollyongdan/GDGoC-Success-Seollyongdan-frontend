...
@Composable
fun TrafficVisualizationScreen(
    onBackClick: () -> Unit,
    trafficLevels: List<String> = listOf(
    ...
    Log.d("TrafficLevels", "Traffic levels: $trafficLevels")
...
@Preview
@Composable
fun TrafficVisualizationScreenPreview() {
