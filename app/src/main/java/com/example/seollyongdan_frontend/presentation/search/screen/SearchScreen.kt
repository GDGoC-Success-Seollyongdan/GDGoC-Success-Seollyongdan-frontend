    ...
    fun SearchRoute(
        ...
        SearchScreen(
            onClickToSearchResult = { navigator.navigateToSearchResult() }
        )
    }
            ...
            content = { paddingValues ->
                Box(
                    ...
                    Column(
                        ...
                        DistrictGroupButton(image = R.drawable.ic_search_wallet, text = "높은 물가, 높은 만족도", onClickToSearchResult = onClickToSearchResult)
                        Spacer(modifier = Modifier.height(8.dp))
                        DistrictGroupButton(image = R.drawable.ic_search_fire, text = "빠르고 효율적인 경제 중심지", onClickToSearchResult = onClickToSearchResult)
                        Spacer(modifier = Modifier.height(8.dp))
                        DistrictGroupButton(image = R.drawable.ic_search_cup, text = "안정적이고 조화로운 주거 환경", onClickToSearchResult = onClickToSearchResult)
                        Spacer(modifier = Modifier.height(8.dp))
                        DistrictGroupButton(image = R.drawable.ic_search_sun, text = "실속 있는 선택, 알뜰한 삶", onClickToSearchResult = onClickToSearchResult)
                        Spacer(modifier = Modifier.height(8.dp))
                        DistrictGroupButton(image = R.drawable.ic_search_puzzle, text = "협력하며 살아가는 삶", onClickToSearchResult = onClickToSearchResult)
                        Spacer(modifier = Modifier.height(8.dp))
                        DistrictGroupButton(image = R.drawable.ic_search_book, text = "느린 발전, 꾸준한 성장", onClickToSearchResult = onClickToSearchResult)
                        Spacer(modifier = Modifier.height(8.dp))
                    }
                }
            }
